...
describe("dreamers utils", function () {
  ...
  describe("encodePath", () => {
    const tests = [
      { args: { d: 0, fill: 0, stroke: 0 } as Path, expected: "000000" },
      { args: { d: 15, fill: 0, stroke: 0 } as Path, expected: "00f000" },
      { args: { d: 15, fill: 15, stroke: 1 } as Path, expected: "00f01f" },
      { args: { d: 17, fill: 200, stroke: 0 } as Path, expected: "011190" },
      { args: { d: 4095, fill: 2047, stroke: 1 } as Path, expected: "ffffff" },
    ];
    tests.forEach((test) => {
      it(`should encode ${test.args} as ${test.expected}`, () => {
    ...
    const tests = [
      {
        args: [
          { d: 0, fill: 0, stroke: 1 },
          { d: 15, fill: 0, stroke: 1 },
        ] as Trait,
        expected: "00000100f001",
      },
      {
        args: [
          { d: 15, fill: 15, stroke: 0 },
          { d: 17, fill: 200, stroke: 1 },
          { d: 4095, fill: 4095, stroke: 0 },
        ] as Trait,
        expected: "00f01e011191fffffe",
      },
    ];
    tests.forEach((test) => {
      it(`should encode ${test.args} as ${test.expected}`, () => {
